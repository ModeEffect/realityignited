 ...
 * Requires Plugins: happy-elementor-addons, elementor
...
if ( defined( 'HAPPY_ADDONS_DEV' ) && true == HAPPY_ADDONS_DEV ) {
	define('HAPPY_ADDONS_PRO_VERSION', time() );
} else {
	define('HAPPY_ADDONS_PRO_VERSION', '2.16.4');
}
define('HAPPY_ADDONS_PRO_REQUIRED_MINIMUM_VERSION', '3.14.0');
...
function hapro_let_the_journey_begin() {
	...
	\Happy_Addons_Pro\Base::instance()->init();
}
