 ...
 * @license GPL-3.0
 *
 * Modified by Caseproof using {@see https://github.com/BrianHenryIE/strauss}.
 */

declare(strict_types=1);

namespace memberpress\courses\GroundLevel\Support\Concerns;
...
trait Hookable
{
     ...
     *
     * @var \memberpress\courses\GroundLevel\Support\Models\Hook[]
     */
     ...
     *
     * @param  \memberpress\courses\GroundLevel\Support\Models\Hook|array $hookOrHookArgs The hook args to initialize the hook with.
     *                                                                Or the hook itself, in which case it is returned
     *                                                                as it is.
     * @return \memberpress\courses\GroundLevel\Support\Models\Hook
     */
