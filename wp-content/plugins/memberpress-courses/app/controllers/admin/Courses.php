...
class Courses extends lib\BaseCptCtrl {
  ...
  public static function save_post_data($post_id) {
    ...
    $course->certificates_text_color = (isset($_POST[models\Course::$certificates_text_color_str])) ? esc_attr($_POST[models\Course::$certificates_text_color_str]) : $course->attrs['certificates_text_color']['default'];
    $course->certificates_paper_size = (isset($_POST[models\Course::$certificates_paper_size_str])) ? esc_attr($_POST[models\Course::$certificates_paper_size_str]) : $course->attrs['certificates_paper_size']['default'];
    $course->certificates_background_color = (isset($_POST[models\Course::$certificates_background_color_str])) ? esc_attr($_POST[models\Course::$certificates_background_color_str]) : $course->attrs['certificates_background_color']['default'];
    $course->certificates_title = (isset($_POST[models\Course::$certificates_title_str])) ? esc_attr($_POST[models\Course::$certificates_title_str]) : $course->attrs['certificates_title']['default'];
    $course->certificates_instructor_name = (isset($_POST[models\Course::$certificates_instructor_name_str])) ? esc_attr($_POST[models\Course::$certificates_instructor_name_str]) : $course->attrs['certificates_instructor_name']['default'];
    $course->certificates_instructor_title = (isset($_POST[models\Course::$certificates_instructor_title_str])) ? esc_attr($_POST[models\Course::$certificates_instructor_title_str]) : $course->attrs['certificates_instructor_title']['default'];
    $course->certificates_footer_message = (isset($_POST[models\Course::$certificates_footer_message_str])) ? esc_attr($_POST[models\Course::$certificates_footer_message_str]) : $course->attrs['certificates_footer_message']['default'];
    $course->certificates_completion_date = (isset($_POST[models\Course::$certificates_completion_date_str])) ? esc_attr($_POST[models\Course::$certificates_completion_date_str]) : $course->attrs['certificates_completion_date']['default'];
    $course->certificates_share_link = (isset($_POST[models\Course::$certificates_share_link_str])) ? esc_attr($_POST[models\Course::$certificates_share_link_str]) : $course->attrs['certificates_share_link']['default'];
    $course->certificates_expiration_date = (isset($_POST[models\Course::$certificates_expiration_date_str])) ? esc_attr($_POST[models\Course::$certificates_expiration_date_str]) : $course->attrs['certificates_expiration_date']['default'];
    $course->certificates_style = (isset($_POST[models\Course::$certificates_style_str])) ? esc_attr($_POST[models\Course::$certificates_style_str]) : $course->attrs['certificates_style']['default'];
    $course->certificates_expires_value = (isset($_POST[models\Course::$certificates_expires_value_str])) ? esc_attr($_POST[models\Course::$certificates_expires_value_str]) : $course->attrs['certificates_expires_value']['default'];
    $course->certificates_expires_unit = (isset($_POST[models\Course::$certificates_expires_unit_str])) ? esc_attr($_POST[models\Course::$certificates_expires_unit_str]) : $course->attrs['certificates_expires_unit']['default'];
    $course->certificates_expires_reset = (isset($_POST[models\Course::$certificates_expires_reset_str])) ? esc_attr($_POST[models\Course::$certificates_expires_reset_str]) : $course->attrs['certificates_expires_reset']['default'];
    $course->dripping = (isset($_POST[models\Course::$dripping_str])) ? esc_attr($_POST[models\Course::$dripping_str]) : $course->attrs['dripping']['default'];

    if( 'enabled' == $course->dripping ) {
      $course->require_previous = 'enabled';
    }

    $course->drip_type = (isset($_POST[models\Course::$drip_type_str])) ? esc_attr($_POST[models\Course::$drip_type_str]) : $course->attrs['drip_type']['default'];
    $course->drip_amount = (isset($_POST[models\Course::$drip_amount_str])) ? esc_attr($_POST[models\Course::$drip_amount_str]) : $course->attrs['drip_amount']['default'];
    $course->drip_time = (isset($_POST[models\Course::$drip_time_str])) ? esc_attr($_POST[models\Course::$drip_time_str]) : $course->attrs['drip_time']['default'];
    $course->drip_timezone = (isset($_POST[models\Course::$drip_timezone_str])) ? esc_attr($_POST[models\Course::$drip_timezone_str]) : $course->attrs['drip_timezone']['default'];
    $course->drip_frequency = (isset($_POST[models\Course::$drip_frequency_str])) ? esc_attr($_POST[models\Course::$drip_frequency_str]) : $course->attrs['drip_frequency']['default'];
    $course->drip_frequency_type = (isset($_POST[models\Course::$drip_frequency_type_str])) ? esc_attr($_POST[models\Course::$drip_frequency_type_str]) : $course->attrs['drip_frequency_type']['default'];
    $course->drip_frequency_fixed_date = (isset($_POST[models\Course::$drip_frequency_fixed_date_str])) ? esc_attr($_POST[models\Course::$drip_frequency_fixed_date_str]) : $course->attrs['drip_frequency_fixed_date']['default'];
    $course->drip_lessons = (isset($_POST[models\Course::$drip_lessons_str])) ? esc_attr($_POST[models\Course::$drip_lessons_str]) : $course->attrs['drip_lessons']['default'];
    $course->drip_quizzes = (isset($_POST[models\Course::$drip_quizzes_str])) ? esc_attr($_POST[models\Course::$drip_quizzes_str]) : $course->attrs['drip_quizzes']['default'];
    $course->drip_assignments = (isset($_POST[models\Course::$drip_assignments_str])) ? esc_attr($_POST[models\Course::$drip_assignments_str]) : $course->attrs['drip_assignments']['default'];
    $course->not_dripped_message = (isset($_POST[models\Course::$not_dripped_message_str])) ? esc_attr($_POST[models\Course::$not_dripped_message_str]) : $course->attrs['not_dripped_message']['default'];
