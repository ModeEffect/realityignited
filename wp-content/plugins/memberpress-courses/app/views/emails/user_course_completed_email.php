...
<div id="body" style="width: 600px; background: white; padding: 40px; margin: 0 auto; text-align: left;">
  <p><?php echo wp_kses_post('Hello <strong>{$user_full_name}</strong>,', 'memberpress-courses'); ?></p>
  <p><?php echo wp_kses_post('Congratulations on completing <strong>{$course_name}</strong>.'); ?></p>
  <p>
    <?php esc_html_e('Access helpful resources here:', 'memberpress-course', 'memberpress-courses'); ?>
    <ul>
